...
EXPECTED_BARE_ASSOCIATION_XML: str = (
    ...
    f'            <ModelClass id="{SOURCE_MODEL_CLASS_ID}" name="GeneratedClass-0" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
    f'        <UmlClass id="{DESTINATION_UML_CLASS_ID}" width="150" height="75" x="200" y="300">\n'
    f'            <ModelClass id="{DESTINATION_MODEL_CLASS_ID}" name="GeneratedClass-1" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
...
EXPECTED_INHERITANCE_XML: str = (
    ...
    f'            <ModelClass id="{SUBCLASS_MODEL_ID}" name="{SUBCLASS_UML_CLASS_NAME}" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
    f'        <UmlClass id="{BASE_UML_CLASS_ID}" width="150" height="75" x="100" y="100">\n'
    f'            <ModelClass id="{BASE_CLASS_MODEL_ID}" name="{BASE_UML_CLASS_NAME}" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
...
EXPECTED_INTERFACE_XML: str = (
    ...
    '            <ModelClass id="4444" name="Implementor" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
    '        <UmlClass id="card.carrying.interface" width="150" height="75" x="3333" y="3333">\n'
    '            <ModelClass id="2222" name="Interface" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    '        </UmlClass>\n'
...
EXPECTED_LOLLIPOP_XML: str = (
    ...
    f'            <ModelClass id="4444" name="{IMPLEMENTING_UML_CLASS_NAME}" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    f'        </UmlClass>\n'
...
EXPECTED_NOTE_LINK_XML: str = (
    ...
    f'            <ModelClass id="{DESTINATION_MODEL_CLASS_ID}" name="DestinationClass" stereotype="noStereotype" displayMethods="True" displayParameters="Unspecified" displayConstructor="Unspecified" displayDunderMethods="Unspecified" displayFields="True" displayStereotype="True" fileName="" description="" />\n'
    f'        </UmlClass>\n'
